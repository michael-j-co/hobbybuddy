...
const AccessoryCustomizationScreen = ({ navigation }) => {
  ...
  const [selectedAccessory, setSelectedAccessory] = useState(
    selectedAvatar.accessory || null
  );
  const [selectedBackground, setSelectedBackground] = useState(
    selectedAvatar.background || null
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.avatarContainer}>
        ...
        {selectedAccessory ? (
          <Image
            source={selectedAccessory.source}
        ...
        {accessories.map((item) => (
          <TouchableOpacity
            ...
            style={[
              ...
              selectedAccessory?.id === item.id ? styles.selectedItem : null,
            ]}
      ...
      >
        {backgrounds.map((item) => (
          <TouchableOpacity
            ...
            style={[
              styles.itemContainer,
              selectedBackground?.id === item.id ? styles.selectedItem : null,
            ]}
